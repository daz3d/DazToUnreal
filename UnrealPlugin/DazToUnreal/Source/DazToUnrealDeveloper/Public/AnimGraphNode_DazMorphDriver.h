...
#include "AnimGraphNode_DazMorphDriver.generated.h"
 ...
 */
UCLASS()
class DAZTOUNREALDEVELOPER_API UAnimGraphNode_DazMorphDriver : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = Settings)
	FAnimNode_DazMorphDriver Node;
